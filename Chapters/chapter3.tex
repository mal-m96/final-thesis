...
#Handling NaN in float cloumns that are below threshold 0.70(70%)
    def handle_nan_values(X):
        ...
        return X
\end{lstlisting}
%#fill nan values with most common in columns of type obj         obj_columns = X.columns[X.dtypes == object]        X[obj_columns] = X[obj_columns].fillna(method="pad")
